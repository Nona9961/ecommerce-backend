 ...
 * <p>
 * 商品聚合含四个从表集合（图片 product_image / 属性 product_attribute /
 * SKU product_sku / 店铺分类绑定 product_shop_category_rel），而
 * {@link RdbGeneralConvertor} 的 other 参数形态单一——本载体将四个集合
...
public record ProductChildPos(
        ...
        List<SkuPO> skus,
        List<ProductShopCategoryRelPO> shopCategoryRefs
) {
}