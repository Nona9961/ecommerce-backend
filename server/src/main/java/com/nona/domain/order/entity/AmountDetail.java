 ...
 * 构成——商品总额/运费/实付，预留优惠字段位（一期无优惠叠加，营销
 * 二期在此叠加，结构免改）。
 * <p>
 * 运费来源（WU-13 契约消费面）：运费由 catalog/order 共用领域服务
 ...
 *     <li>一期优惠恒 0（装配契约由用例层承载，本 VO 不设非零拒绝——
 *         预留位随二期叠加启用，模型免改）。</li>
 * </ol>
 *
 * @author nona9961
...
public class AmountDetail {
    ...
    /**
     * 运费（分：经 WU-13 运费计算器按店铺模板算得）
     */
    private final long freightAmount;

    /**
     * 优惠金额（分，位预留：一期恒 0，营销二期叠加）
     */
     ...
     * @param discount      优惠金额（分，非负；一期恒 0）
