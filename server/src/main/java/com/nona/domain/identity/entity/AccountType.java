...
/**
 * 账号类型：同一 Account 聚合的角色值（领域模型 M5：Account 聚合只有一个，
 * 内容 = credentials + status + type；buyer 与 merchant 是同一聚合的 type 值，
 * 不是两类结构）。
 * <p>
 ...
 * （WU-10 Role/Permission/Assignment，Phase-II），本枚举不为其设计落点；
