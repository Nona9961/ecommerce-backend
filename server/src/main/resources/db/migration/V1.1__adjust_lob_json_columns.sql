-- =============================================================================
-- V1.1 修正（WU-53 绿阶段实测发现）：@Lob JSON 列 tinytext → text
-- =============================================================================
-- 【事由】V1 依 Hibernate 6 导出，三个 @Lob String 列映射为 MySQL tinytext
--   （255 字节上限）。实测（MySQL 8.4.8 宿主）商品编辑快照/规范模板/待审草稿
