 ...
 * ProductEditVersionUniqueConstraintTest）。
 * <p>
 * 红状态说明：本文件断言机械装配（版本行插行/分页/租户过滤/级联）——
 * 红阶段为绿底座；版本链领域语义（保存留痕/版本号递增分配/回滚编排）
 * 由 ProductVersionUseCaseIntegrationTest / ProductRestoreContentTest
 * 以红因承载（UnsupportedOperationException）。
 */
@SpringBootTest(properties = "management.health.redis.enabled=false")
class ProductEditVersionRepositoryIntegrationTest {
